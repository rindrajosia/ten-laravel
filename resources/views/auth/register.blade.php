                ...
                @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="name" type="text" name="name" value="{{ old('name')}}" class="form-control pl-15 bg-transparent text-white plc-white" required autofocus placeholder="Full Name">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="email" type="email" name="email" value="{{ old('email')}}" class="form-control pl-15 bg-transparent text-white plc-white" required placeholder="Email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="password" type="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" required placeholder="Password">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="password_confirmation" type="password" name="password_confirmation" class="form-control pl-15 bg-transparent text-white plc-white" required  placeholder="Retype Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-12">
