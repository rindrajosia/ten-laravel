                  ...
                  <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row">
                      <div class="form-group col-md-12 mb-4">
                        <input type="text" name="name" class="form-control input-lg" id="name" aria-describedby="nameHelp" required autofocus placeholder="Name">
                      </div>
                      <div class="form-group col-md-12 mb-4">
                      ...
                      <div class="form-group col-md-12 ">
                        <input type="password" name="password_confirmation" required class="form-control input-lg" id="cpassword" placeholder="Confirm Password">
                      </div>
                      <div class="col-md-12">
